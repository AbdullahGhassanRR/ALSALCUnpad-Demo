"use client"
import { PublicationResponse, Newsletter, formatPublicationLabel} from '@/components/dynamic/PublicationPreview';
    ...
    useEffect(function(){
        ...
        async function loadResources(){
            try {
                ...
                if (!response.ok){
                    console.log("No response when fetching. inside async function loadResources-> !response.ok");
                ...
                if (!payload.success || !payload.data || payload.data.length === 0) {
                    console.log("Failed in async function loadResources-> !payload.success etc");
                ...
                console.log("Failed in async function loadResources");
            }
        }
