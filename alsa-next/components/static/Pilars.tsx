...
const CONTAINER_BASE_CLASSES = 
  ...
  "bg-cover rounded-[clamp(12px,2vw,20px)] max-md:justify-evenly";

// DRY: Shared styles for the icon column
const ICON_CONTAINER_CLASSES = 
  "flex-1 ml-[clamp(1.5rem,8vw,13rem)] max-md:flex-none max-md:flex max-md:justify-center items-center max-md:ml-[0px]";
      ...
      {PILARS.map(function (pilar, index) {
        ...
        return (
          <div 
            id='pilars-container'
            key={index} 
            className={`${CONTAINER_BASE_CLASSES}`}
